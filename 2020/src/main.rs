...
fn main() {
    ...
    programs.insert(String::from("10-1"), day_10_part_1::process);
    programs.insert(String::from("10-2"), day_10_part_2::process);
    ...
    programs.insert(String::from("16-1"), day_16_part_1::process);
    programs.insert(String::from("16-2"), day_16_part_2::process);
